...
namespace HoSGUI {
  ...
  class pos_tail_t {
  public:
    static int addpoint(const char *path, const char *types, lo_arg **argv, int argc, lo_message msg, void *user_data);
    pos_tail_t(const std::string& pAddr, lo_server_thread & lost, unsigned int k);
    ~pos_tail_t();
