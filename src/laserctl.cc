...
public:
  ...
  static int osc_set_mic(const char *path, const char *types, lo_arg **argv, int argc, lo_message msg, void *user_data);
...
int tasten_t::osc_set_mic(const char *path, const char *types, lo_arg **argv, int argc, lo_message msg, void *user_data)
{
...
tasten_t::tasten_t(const std::string& dev,
                   const std::string& server_address,
                   const std::string& server_port)
  : SerialPort(dev),
