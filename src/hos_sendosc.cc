      ...
      if(strlen(rbuf)) {
        if(rbuf[0] == ',') {
          ...
          case 2:
            ...
            break;
          case 3:
            lo_send(lo_addr, addr, "ff", val0, val1);
            break;
          case 4:
            lo_send(lo_addr, addr, "fff", val0, val1, val2);
            break;
          case 5:
            lo_send(lo_addr, addr, "ffff", val0, val1, val2, val3);
            break;
          case 6:
            lo_send(lo_addr, addr, "fffff", val0, val1, val2, val3, val4);
            break;
          case 7:
            lo_send(lo_addr, addr, "ffffff", val0, val1, val2, val3, val4,
                    val5);
            break;
          case 8:
            lo_send(lo_addr, addr, "fffffff", val0, val1, val2, val3, val4,
                    val5, val6);
            break;
          case 9:
            lo_send(lo_addr, addr, "ffffffff", val0, val1, val2, val3, val4,
                    val5, val6, val7);
            break;
          case 10:
            lo_send(lo_addr, addr, "fffffffff", val0, val1, val2, val3, val4,
                    val5, val6, val7, val8);
            break;
          case 11:
            lo_send(lo_addr, addr, "ffffffffff", val0, val1, val2, val3, val4,
