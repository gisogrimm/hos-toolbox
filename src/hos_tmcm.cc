...
public:
  ...
  static int osc_move_to(const char* path, const char* types, lo_arg** argv,
                         int argc, lo_message msg, void* user_data);
  static int osc_rfs(const char* path, const char* types, lo_arg** argv,
                     int argc, lo_message msg, void* user_data);
  static int osc_relais(const char* path, const char* types, lo_arg** argv,
                        int argc, lo_message msg, void* user_data);
...
int hos_spokes_t::osc_move_to(const char* path, const char* types,
...
int hos_spokes_t::osc_rfs(const char* path, const char* types, lo_arg** argv,
                          int argc, lo_message msg, void* user_data)
{
  if(user_data)
...
int hos_spokes_t::osc_relais(const char* path, const char* types, lo_arg** argv,
                             int argc, lo_message msg, void* user_data)
{
...
hos_spokes_t::hos_spokes_t(const std::string& devname)
    : tmcm6110_t(), TASCAR::osc_server_t("239.255.1.7", "6978", "UDP"),
      b_quit(false)
{
  set_prefix("/tmcm");
  dev_open(devname);
