...
namespace MM {
  ...
  public:
    ...
    unsigned int index(unsigned int kout, unsigned int kin)
    {
      return kout + n_out_ * kin;
    };
    ~gainmatrix_t();
    ...
    double get_gain(unsigned int kout, unsigned int kin)
    {
      return G[index(kout, kin)];
    };
    double get_pan(unsigned int kout, unsigned int kin)
    {
      return P[index(kout, kin)];
    };
    ...
    std::vector<unsigned int> get_outports(unsigned int k)
    {
      return outports[k];
    };
    std::vector<unsigned int> get_inports(unsigned int k)
    {
      return inports[k];
    };
    void lock() { pthread_mutex_lock(&mutex); };
    void unlock() { pthread_mutex_unlock(&mutex); };
    bool ismodified(observer_t* o)
    {
      bool btmp(modified[o]);
      modified[o] = false;
      return btmp;
    };
  ...
  protected:
    ...
    virtual void modified_outports(unsigned int k,
                                   const std::vector<unsigned int>& p){};
    virtual void modified_inports(unsigned int k,
                                  const std::vector<unsigned int>& p){};
  ...
  public:
    lo_matrix_t(unsigned int nout, unsigned int nin, lo_server_thread& ilost,
                lo_address& iaddr);
    virtual ~lo_matrix_t();
  ...
  private:
    static int osc_set_name_in(const char* path, const char* types,
                               lo_arg** argv, int argc, lo_message msg,
                               void* user_data);
    static int osc_set_name_out(const char* path, const char* types,
                                lo_arg** argv, int argc, lo_message msg,
                                void* user_data);
    static int osc_set_gain_out(const char* path, const char* types,
                                lo_arg** argv, int argc, lo_message msg,
                                void* user_data);
    static int osc_set_gain(const char* path, const char* types, lo_arg** argv,
                            int argc, lo_message msg, void* user_data);
    static int osc_set_pan(const char* path, const char* types, lo_arg** argv,
                           int argc, lo_message msg, void* user_data);
    static int osc_set_mute(const char* path, const char* types, lo_arg** argv,
                            int argc, lo_message msg, void* user_data);
    static int osc_set_inports(const char* path, const char* types,
                               lo_arg** argv, int argc, lo_message msg,
                               void* user_data);
    static int osc_set_outports(const char* path, const char* types,
                                lo_arg** argv, int argc, lo_message msg,
                                void* user_data);
    static int osc_set_select_in(const char* path, const char* types,
                                 lo_arg** argv, int argc, lo_message msg,
                                 void* user_data);
    static int osc_set_select_out(const char* path, const char* types,
                                  lo_arg** argv, int argc, lo_message msg,
                                  void* user_data);
